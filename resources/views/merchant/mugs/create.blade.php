            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <span>Create New Mug</span>
                        <a href="{{ route('merchant.dashboard') }}" class="btn btn-secondary btn-sm">Back to Dashboard</a>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('merchant.mugs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary">Create Mug</button>
                    </form>
                </div>
            </div>
        </div>
